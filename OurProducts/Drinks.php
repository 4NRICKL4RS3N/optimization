			...
			<tr>
				...
				if (mysqli_num_rows($getposts)) {
					...
					while ($row = mysqli_fetch_assoc($getposts)) {
						...
						echo '
							<th>
								<a href="NoodlesCanned.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: '.($cName == $cat).';border-radius: 12px;">'.$display.'</a>
							</th>
						';
					}
				}
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid=' . $id . '">
										<img src="../image/product/drink/' . $picture . '" class="home-prodlist-imgi" alt=' . $pName . '>
										</a>
